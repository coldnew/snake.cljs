...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([initial_state,p1__16824_SHARP_], 0));
});})(initial_state))
);
});
/**
...
var nav_2d_16825 = cljs.core.cst$kw$navigation_DASH_2d.cljs$core$IFn$_invoke$arity$1(state);
var zoom_16826 = cljs.core.cst$kw$zoom.cljs$core$IFn$_invoke$arity$1(nav_2d_16825);
var pos_16827 = cljs.core.cst$kw$position.cljs$core$IFn$_invoke$arity$1(nav_2d_16825);
quil.core.scale.cljs$core$IFn$_invoke$arity$1(zoom_16826);

var tr__16747__auto___16828 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width() / (2)) / zoom_16826) - cljs.core.first(pos_16827)),(((quil.core.height() / (2)) / zoom_16826) - cljs.core.second(pos_16827))], null);
quil.core.push_matrix();

try{quil.core.translate.cljs$core$IFn$_invoke$arity$1(tr__16747__auto___16828);
...
var G__16833 = quil.middlewares.navigation_2d.mouse_dragged(state,event);
var G__16834 = event;
return (user_mouse_dragged.cljs$core$IFn$_invoke$arity$2 ? user_mouse_dragged.cljs$core$IFn$_invoke$arity$2(G__16833,G__16834) : user_mouse_dragged.call(null,G__16833,G__16834));
...
return (function (state,event){
var G__16835 = quil.middlewares.navigation_2d.mouse_wheel(state,event);
var G__16836 = event;
return (user_mouse_wheel.cljs$core$IFn$_invoke$arity$2 ? user_mouse_wheel.cljs$core$IFn$_invoke$arity$2(G__16835,G__16836) : user_mouse_wheel.call(null,G__16835,G__16836));
});})(user_settings,user_draw,user_mouse_dragged,user_mouse_wheel,setup))
], 0));
});
